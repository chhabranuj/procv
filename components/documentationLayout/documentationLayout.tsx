import documentationStyle from "./documentationLayout.module.sass";

const DocumentationLayout = (props: any) => {
  return (
    <div className={documentationStyle.documentationParent}>
      {props.title == "Privacy Policy" ? (
        <div className={documentationStyle.documentationChild}>
          <p className={documentationStyle.documentationText}>
          ...
          <h3 className={documentationStyle.documentationText}>
            Interpretation
          </h3>
          <p className={documentationStyle.documentationText}>
          ...
          <h3 className={documentationStyle.documentationText}>Definitions</h3>
          <p className={documentationStyle.documentationText}>
          ...
          <ul>
            ...
            <li>
              <p className={documentationStyle.documentationText}>
                ...
                in this Agreement) refers to ProCv.
              </p>
            </li>
            <li>
              <p className={documentationStyle.documentationText}>
            ...
            <li>
              <p className={documentationStyle.documentationText}>
                <strong>Website</strong> refers to ProCv, accessible from{" "}
                <a
                  href="https://procv.vercel.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://procv.vercel.app
                </a>
              </p>
            </li>
            <li>
          ...
          <h4 className={documentationStyle.documentationText}>
            Personal Data
          </h4>
          <p className={documentationStyle.documentationText}>
          ...
          <ul>
            ...
            <li>
              <p className={documentationStyle.documentationText}>Usage Data</p>
            </li>
          </ul>
          <h4 className={documentationStyle.documentationText}>Usage Data</h4>
          <p className={documentationStyle.documentationText}>
          ...
          <ul>
            <li className={documentationStyle.documentationText}>
          ...
          <h2 className={documentationStyle.documentationText}>
            Children's Privacy
          </h2>
          <p className={documentationStyle.documentationText}>
          ...
          <h2 className={documentationStyle.documentationText}>Contact Us</h2>
          <p className={documentationStyle.documentationText}>
          ...
          <ul>
            <li className={documentationStyle.documentationText}>
              ...
              <a
                href="https://procv.vercel.app/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://procv.vercel.app/contact
              </a>
            </li>
            <li className={documentationStyle.documentationText}>
              By visiting through Email:{" "}
              <a
                href="mailto:procv.contact@gmail.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                procv.contact@gmail.com
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className={documentationStyle.documentationChild}>
          <p className={documentationStyle.documentationText}>
            ...
            use of procv's Website, located at https://procv.vercel.app.
          </p>

          <p className={documentationStyle.documentationText}>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use ProCv if you do not agree to take
          ...
          <p className={documentationStyle.documentationText}>
            We employ the use of cookies. By accessing ProCv, you agreed to use
            cookies in agreement with the procv's Privacy Policy.
          </p>
          ...
          <p className={documentationStyle.documentationText}>
            Unless otherwise stated, procv and/or its licensors own the
            intellectual property rights for all material on ProCv. All
            intellectual property rights are reserved. You may access this from
            ProCv for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p className={documentationStyle.documentationText}>You must not:</p>
          <ul>
            <li className={documentationStyle.documentationText}>
              Republish material from ProCv
            </li>
            <li className={documentationStyle.documentationText}>
              Sell, rent or sub-license material from ProCv
            </li>
            <li className={documentationStyle.documentationText}>
              Reproduce, duplicate or copy material from ProCv
            </li>
            <li className={documentationStyle.documentationText}>
              Redistribute content from ProCv
            </li>
          </ul>
          ...
          <p className={documentationStyle.documentationText}>
            ...
            procv does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of procv,its agents and/or affiliates. Comments reflect the
            views and opinions of the person who post their views and opinions.
            To the extent permitted by applicable laws, procv shall not be
          ...
          <p className={documentationStyle.documentationText}>
            procv reserves the right to monitor all Comments and to remove any
          ...
          <p className={documentationStyle.documentationText}>
            You hereby grant procv a non-exclusive license to use, reproduce,
          ...
          <p className={documentationStyle.documentationText}>
            ...
            visibility of the hyperlink compensates the absence of procv; and
          ...
          <p className={documentationStyle.documentationText}>
            ...
            sending an e-mail to procv. Please include your name, your
          ...
          <p className={documentationStyle.documentationText}>
            No use of procv's logo or other artwork will be allowed for linking
